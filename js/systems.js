...
function render(){
 ...
 renderFeatureLocks();applyFeatureViewLocks();renderPatchNotes();renderCollection();renderDiagnostics();renderPets();renderShop();renderWorlds();renderSkins();renderCasino();if(typeof renderMiniCooldowns==='function')if(typeof renderMiniCooldowns==='function')renderMiniCooldowns();renderMiniStats();maybeSpawnBoss();renderAchievements();renderQuests();renderStats();renderDaily();renderBoard();applySkin();save()
}
